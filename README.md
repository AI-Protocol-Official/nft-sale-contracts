# AI Protocol NFT Sale Contracts #
NFT Sale contracts for AI Protocol
...
* Smart Contract(s):
    * [ERC721Drop](contracts/protocol/ERC721Drop.sol) – ERC721Drop implementation
    * [FixedSupplySale](contracts/protocol/FixedSupplySale.sol) – FixedSupplySale implementation
    * [MintableSale](contracts/protocol/MintableSale.sol) – MintableSale implementation
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/nft-sale-contracts.git```
2. Navigate into the cloned repository  
    ```cd nft-sale-contracts```
